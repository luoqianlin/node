...
readonly REPOSITORY="${REPOSITORY:-https://github.com/luoqianlin/node.git}"
readonly REF="${REF:-android11-v24.19.0}"
readonly WORK_DIR="${WORK_DIR:-$PWD/node-android11-build}"
